package com.example.woofappinunit3.module

import androidx.annotation.DrawableRes
import androidx.annotation.StringRes
import com.example.woofappinunit3.R
...
val listDog=
    listOf(Dog(R.drawable.koda, R.string.dog_name_1, 2, R.string.dog_description_1),
